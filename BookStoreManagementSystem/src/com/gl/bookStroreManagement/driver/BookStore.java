package com.gl.bookStroreManagement.driver;
import java.util.ArrayList;
import java.util.List;
import java.util.stream.Collectors;
import com.gl.util.Book;
public class BookStore {
	public static void main(String[] args) {
		...
		books.add(book9);
		books.add(book10);
		books.forEach(//for each book, printing their id,name,price and genre.
		...
		//Above list contains name of the book with same Genre
		...
		//Count of books after distinct of Genre names.
	}
}
